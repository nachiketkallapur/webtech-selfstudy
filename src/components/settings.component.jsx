        ...
        <div style={{
            ...
            <form onSubmit={handleSubmit} autoComplete="off">
                ...
                <TextField
                    ...
                    defaultValue={lastAlertEmailSent!==null ? new Date(parseInt(lastAlertEmailSent)): "No emails are sent yet"}
                    variant="filled"
                    type="email"
                    onChange={handleChange}
                    style={{ width: "470px", margin: "5px 0px" }}
                ...
                <FormControl component="fieldset">
                    ...
                    <RadioGroup aria-label="autoEmail" name="autoEmail" value={autoEmail} defaultValue="false" onChange={handleChange}>
                        <FormControlLabel value="true" checked={autoEmail==="true"} control={<Radio />} label="Yes" />
                        <FormControlLabel value="false" checked={autoEmail==="false"} control={<Radio />} label="No" />
                    </RadioGroup>
                </FormControl><br />
                <TextField
                    required
