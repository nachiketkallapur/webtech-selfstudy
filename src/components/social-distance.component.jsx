...
class SocialDistance extends React.Component {
    ...
    sendAlertEmail = () => {
        ...
        // console.log(settings.lastAlertEmailSent);
        // console.log(new Date().getTime() - settings.lastAlertEmailSent < 300000);
        // console.log(settings.autoEmail);

        //3,00,000 milliseconds = 5 minutes
        if (settings.lastAlertEmailSent !== null && (new Date().getTime() - settings.lastAlertEmailSent < 300000)) {
        ...
        if (
            ...
            net.detect(video)
                .then(tempobj => {
                    ...
                    // console.log(this.state.lastAutoEmailSent);
                    const {settings}=this.state;
                    if (settings.autoEmail === "true" && this.state.numberOfPeople > settings.threshold && (new Date().getTime() - settings.lastAlertEmailSent) > 300000
